...
const SingleExperience = ({ experience }) => {
  return (
    <div className='md:w-[280px] md:h-[380px] sm:h-auto sm:w-full border-2 border-orange border-dashed rounded-2xl p-5 shadow-lg hover:scale-[1.02] transition-all duration-500 mt-4'>

...
const ExperienceTopRight = () => {
  ...
  return (
    <div className='xl:w-[35%] lg:w-[45%] border border-lightBrown p-4 rounded-xl'>
      <p className='text-lg text-center text-lightGrey'>I have a sound knowledge in <span className={spanClass}> React and modern JavaScript</span>, focused on building scalable, clean, and user-friendly web applications. With <span className={spanClass}>industrial training in the MERN stack and current Java Full Stack Development</span>, I’m comfortable working across the stack.

        I've delivered some industry standard <span className={spanClass}> freelance projects </span> gaining real-world experience in both design and development.
